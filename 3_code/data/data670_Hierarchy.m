...
load('relation.mat','rank_mp_mp','mp_id');

mmu_mp_mp = 1+log(rank_mp_mp);
mmu_mp_mp(mmu_mp_mp<0) = 0;
...
save('data670_Hierarchy.mat','mmu_mp_mgi');
save('data670_Hierarchy.mat','mmu_mgi_ids','mmu_mp_ids','-append');
save('data670_Hierarchy.mat','mmu_pathway_mgi','mmu_ppi','-append');
save('data670_Hierarchy.mat','mmu_mp_mp','-append');
